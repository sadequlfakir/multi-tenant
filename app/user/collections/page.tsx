...
import type { Collection, Product, Tenant } from '@/lib/types'
  ...
  const loadData = async (token: string) => {
    try {
      ...
      const [collectionsRes, productsRes] = await Promise.all([
        fetch(`/api/collections?subdomain=${userTenant.subdomain}`),
      ...
      <header className="bg-white border-b sticky top-0 z-30 shadow-sm">
        <div className="px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Home Page Collections</h1>
              <p className="text-sm text-gray-500 mt-1">
                Create sections with title, description, and products for your storefront home
              </p>
            </div>
            <Button
          ...
          <Card className="max-w-2xl mx-auto">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Add collections to show multiple sections on your home page (e.g. &quot;New Arrivals&quot;, &quot;Best Sellers&quot;). Each has a title, description, and products.
              </p>
              <Button
                onClick={() => handleOpenDialog()}
                className="bg-gradient-to-r from-blue-500 to-indigo-600"
        ...
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              {activeProducts.length === 0 ? (
                <p className="text-sm text-gray-500">
                  No active products. <Link href="/user/products" className="text-blue-600 underline">Add products</Link> first.
                </p>
              ) : (
                <>
            ...
            <DialogFooter>
              ...
              <ButtonWithLoader type="submit" loading={saving} loadingLabel={editingCollection ? 'Updating...' : 'Creating...'} className="bg-gradient-to-r from-blue-500 to-indigo-600">
